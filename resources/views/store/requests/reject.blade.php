...
<div class="modal fade" id="ModalReject{{$ombi->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ url('reject-maombi/'.$ombi->id) }}" method="post" enctype="multipart/form-data"
